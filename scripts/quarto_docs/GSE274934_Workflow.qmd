...
df = pd.read_csv("../../results/GSE274934/csvs/scvi_all_vs_rest_DGEA.csv")

selected_columns = ["Unnamed: 0", "celltype", "bayes_factor", "lfc_mean", "comparison"]
df = df[selected_columns]
top_degs = df.sort_values(by=["celltype", "lfc_mean"], ascending = [True, True]).groupby("celltype").head(5)
