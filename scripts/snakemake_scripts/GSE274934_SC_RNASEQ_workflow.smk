...
rule run_scanpy_script:
  ...
  output:
    ...
    violin_qc = "results/GSE274934/violin_qc.png",
    scatter_mito = "results/GSE274934/scatter_total_counts_vs_per_mito_counts.png",
    scatter_genes_by_counts = "results/GSE274934/scatter_total_counts_vs_gene_counts.png",
    samples_umap = "results/GSE274934/umap_samples_scvi.png",
    leiden_umap = "results/GSE274934/umap_leiden_scvi_clusters.png",
    qc_umap = "results/GSE274934/umap_qc_metrics_scvi.png"
  shell:
    """
    python scripts/python_scripts/GSE274934_single_cell_workflow.py \
...
rule run_celltype_annotation:
  input:
    processed_h5ad_file = "data/processed/GSE274934/processed_anndata.h5ad",
    vae_file = directory("data/processed/GSE274934/vae_file")
  output:
    celltypist_map = "results/GSE274934/umap_celltypist.png"
  params:
    csv_output_dir = "results/GSE274934/csvs",
    figures_dir = "results/GSE274934/"
  shell:
    """
    python scripts/python_scripts/GSE274934_single_cell_workflow.py \
