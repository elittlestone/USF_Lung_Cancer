...
rule run_scanpy_script:
  ...
  output:
    ...
    scatter_genes_by_counts = "results/geofigures/GSE274934/scatter_total_counts_vs_gene_counts.png",
    samples_umap = "results/geofigures/GSE274934/umap_samples_scvi.png",
    leiden_umap = "results/geofigures/GSE274934/umap_leiden_scvi_clusters.png",
    qc_umap = "results/geofigures/GSE274934/umap_qc_metrics_scvi.png"
  shell:
    """
...
rule run_celltype_annotation:
  input:
    processed_h5ad_file = "data/processed/GSE274934/concatenated_anndata.h5ad",
    vae_file = directory("data/processed/GSE274934/vae_file")
  output:
    celltypist_map = "results/geofigures/GSE274934/umap_celltypist.png"
  params:
    csv_output_dir = "results/GSE274934/geo_csv",
    figures_dir = directory("results/geofigures/GSE274934/volcano_plots")
  shell:
    """
    python scripts/python_scripts/ALK_positive_single_cell_workflow.py \
